...
<form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md max-w-md">
    @csrf
    @method('PUT')
    <!-- Sama seperti create, tapi value dari $product -->
    <div class="mb-4">
        <label class="block text-gray-700 text-sm font-bold mb-2">Kategori</label>
        <select name="category" class="w-full px-3 py-2 border rounded focus:outline-none @error('category') border-red-500 @enderror">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="name" value="{{ $product->name }}" class="w-full px-3 py-2 border rounded focus:outline-none @error('name') border-red-500 @enderror">
    ...
    <div class="mb-4">
        ...
        <input type="number" name="price" step="0.01" value="{{ $product->price }}" class="w-full px-3 py-2 border rounded focus:outline-none @error('price') border-red-500 @enderror">
